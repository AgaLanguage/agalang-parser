...
impl PartialEq for TokenType {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (Self::Operator(a), Self::Operator(b)) => a == b || (*a == OperatorType::None) || (*b == OperatorType::None),
            (Self::Punctuation(a), Self::Punctuation(b)) => a == b || (*a == PunctuationType::None) || (*b == PunctuationType::None),
            (Self::Keyword(a), Self::Keyword(b)) => a == b || (*a == KeywordsType::None) || (*b == KeywordsType::None),
